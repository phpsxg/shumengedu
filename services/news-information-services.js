...
function detail(id){
    if(getUrlPara()!=undefined){
        // szll 标识师资导航
        window.location.href="detail.html?id="+id+'&type_id='+getUrlPara()+'&szll=1';
    }else{
